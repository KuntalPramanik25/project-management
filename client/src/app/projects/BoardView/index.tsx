...
const TaskColumn = ({ status, tasks, moveTask, setIsModalNewTaskOpen }: TaskColumnProps) => {
    ...
    return (
        <div className={`sl:py-4 rounded-lg py-2 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neutral-950" : ""}`}
            ref={(instance) => {
                drop(instance);
            }}>
                ...
                : priority === "High"
                    ...
                    : priority === "Medium"
                        ...
                        : priority === "Low"
                            ...
                            : "bg-gray-200 text-gray-700"}`}>{priority}
        </div>
    );
        ...
        <div ref={(instance) => { drag(instance) }}
            ...
            <div className='p-4 md:p-6'>
                ...
                <div className='text-xs text-gray-600 dark:text-neutral-400'>
                    {formatttedStartDate && <span>{formatttedStartDate} - </span>}
                    {formatttedDueDate && <span>{formatttedDueDate}</span>}
                </div>
